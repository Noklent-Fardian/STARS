...
class MahasiswaManagementController extends Controller
{
    ...
    public function storeAjax(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'mahasiswa_provinsi_text'  => 'nullable|string|max:255',
            'mahasiswa_kota_text'      => 'nullable|string|max:255',
            'mahasiswa_kecamatan_text' => 'nullable|string|max:255',
            'mahasiswa_desa_text'      => 'nullable|string|max:255',
