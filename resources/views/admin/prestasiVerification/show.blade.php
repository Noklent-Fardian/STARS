                        ...
                        <div class="card-body">
                            <form id="verificationForm">
                                ...
                                <div class="verification-actions">
                                    <button type="button" class="btn btn-success btn-verify" onclick="submitVerification('Diterima')">
                                        <i class="fas fa-check mr-2"></i>Terima Prestasi
                                    </button>
                                    <button type="button" class="btn btn-danger btn-verify" onclick="submitVerification('Ditolak')">
                        ...
                        success: function(response) {
                            ...
                            if (response.success) {
                                Swal.fire({
                                    ...
                                    window.location.href = "{{ route('admin.prestasiVerification.index') }}";
                                });
                            } else {
                                showError(response.message || 'Terjadi kesalahan saat memproses verifikasi.');
                            }
                        },
                        error: function(xhr) {
                            hideLoading();
