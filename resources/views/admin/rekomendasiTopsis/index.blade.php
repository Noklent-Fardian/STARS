        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Generate Rekomendasi Mahasiswa untuk Lomba IT (Topsis Method)</h6>
                </div>
                <div class="card-body">
                    <div class="mb-4">
                        <h6 class="text-muted">
                            <i class="fas fa-info-circle"></i> Sistem ini akan merekomendasikan mahasiswa terbaik untuk mengikuti lomba IT berdasarkan metode TOPSIS dengan 4 kriteria:
                        </h6>
                    ...
                    @if($lombaAkanDatang->count() > 0)
                        <form action="{{ route('admin.rekomendasiTopsis.generate') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
