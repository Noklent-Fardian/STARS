            ...
            <div class="modal-body p-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input value="{{ $admin->admin_name }}" type="text" name="admin_name"
                            id="admin_name" class="form-control" placeholder="Masukkan nama admin" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input value="{{ $admin->user->username }}" type="text" name="username" 
                            id="username" class="form-control" placeholder="Masukkan username" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group shadow-sm">
                        ...
                        <input type="password" name="password" id="password" 
                            class="form-control border-0 py-2" style="transition: all 0.3s"
                            placeholder="Masukkan password baru">
                        <div class="input-group-append m-0">
                            <button class="btn btn-outline-secondary border-0 toggle-password m-0" 
                                type="button" style="transition: all 0.3s; margin: 0;" 
...
<script>
    $(document).ready(function () {
                ...
                password: {
                    minlength: "Password minimal 8 karakter"
                            ...
                            if ($('.card-header:contains("Detail Admin")').length > 0) {
                                ...
                                updateDetailView({
                                    name: $('#admin_name').val(),
                                    gender: $('#admin_gender').val() === 'Laki-laki' ? 'Laki-laki' : 'Perempuan',
                                    phone: $('#admin_nomor_telepon').val(),
        ...
        function updateDetailView(data) {
            ...
            // Find the last updated timestamp field and update it
            $(tableRows).each(function(index) {
                const infoLabel = $(this).find('.info-label span').text();
