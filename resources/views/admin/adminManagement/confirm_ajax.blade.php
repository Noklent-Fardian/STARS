...
@else
    <form action="{{ route('admin.adminManagement.destroyAjax', $admin->id) }}" method="POST" id="form-delete">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <div class="alert alert-warning">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Apakah Anda yakin ingin menghapus admin berikut?</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="mb-1 font-weight-bold text-primary">Nama Admin:</p>
                                    <h5>{{ $admin->admin_name }}</h5>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <h5>{{ $admin->admin_gender == 'Laki-laki' ? 'Laki-laki' : 'Perempuan' }}</h5>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <p class="mb-1 font-weight-bold text-warning">Nomor Telepon:</p>
                                    <h5>{{ $admin->admin_nomor_telepon }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 alert alert-danger">
                        <i class="fas fa-exclamation-circle mr-2"></i> Menghapus admin ini akan menonaktifkan akun pengguna terkait. Data tidak akan benar-benar dihapus dari database.
                    </div>
                </div>
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    if (response.status) {
                                        ...
                                        const isShowPage = $('.card-header:contains("Detail Admin")').length > 0;
                                        ...
                                        if (isShowPage) {
                                            ...
                                            Swal.fire({
                                                ...
                                                willClose: () => {
                                                    ...
                                                    window.location.href = "{{ route('admin.adminManagement.index') }}";
                                                }
                                            });
                                        } else {
