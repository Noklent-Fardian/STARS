...
@section('page-title', 'Hasil Rekomendasi SAW')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="{{ route('admin.rekomendasiSaw.index') }}" class="btn btn-secondary btn-sm">
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary">Hasil Rekomendasi Mahasiswa (Metode SAW)</h6>
                ...
                <div class="card-body">
                                ...
                                @foreach($rekomendasi as $index => $item)
                                    <tr class="{{ $index < 3 ? 'table-success' : '' }}">
                                        <td class="text-center">
                                            <span class="badge badge-{{ $index == 0 ? 'warning' : ($index == 1 ? 'secondary' : ($index == 2 ? 'info' : 'light')) }}">
                                                #{{ $index + 1 }}
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <span class="badge badge-primary">{{ number_format($item['skor_preferensi'], 4) }}</span>
                                        </td>
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <a href="{{ route('admin.rekomendasiSaw.index') }}" class="btn btn-secondary">
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h6 class="text-primary">Interpretasi Nilai SAW:</h6>
                            <ul class="text-muted">
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <strong>Catatan:</strong> Hasil rekomendasi ini dihitung menggunakan metode SAW (Simple Additive Weighting) 
                        yang memberikan bobot pada setiap kriteria dan menghitung total skor berdasarkan penjumlahan nilai terbobot.
                    </div>
                </div>
            </div>
        </div>
...
$(document).on('click', '#btn-konfirmasi-rekomendasi', function() {
    ...
    // Kirim AJAX request
    $.ajax({
        url: '{{ route("admin.rekomendasiSaw.kirimRekomendasi") }}',
        method: 'POST',
        data: {
            _token: '{{ csrf_token() }}',
...
function exportToExcel() {
    ...
    downloadLink.download = "rekomendasi_mahasiswa_saw_{{ $lomba->lomba_nama }}.csv";
