                                ...
                                @foreach ($rekomendasi as $index => $item)
                                    <tr class="{{ $index < 3 ? 'table-success' : '' }}">
                                        <td class="text-center">
                                            <span
                                                class="badge badge-{{ $index == 0 ? 'warning' : ($index == 1 ? 'secondary' : ($index == 2 ? 'info' : 'light')) }}">
                                                #{{ $index + 1 }}
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <span
                                                class="badge badge-primary">{{ number_format($item['skor_preferensi'], 4) }}</span>
                                        </td>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <strong>Catatan:</strong> Hasil rekomendasi ini dihitung menggunakan metode SAW (Simple Additive
                        Weighting)
                        yang memberikan bobot pada setiap kriteria dan menghitung total skor berdasarkan penjumlahan nilai
                        terbobot.
                    </div>
                </div>
            </div>
