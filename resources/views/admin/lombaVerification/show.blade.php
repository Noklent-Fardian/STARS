    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.show-link-modal').on('click', function(e) {
                ...
                if (/\.(jpg|jpeg|png|gif|webp)(\?.*)?$/i.test(url)) {
                    bodyHtml = `
                        <div class="text-center">
                            <img src="${url}" alt="Poster" style="max-width:100%;max-height:500px;border-radius:8px;">
                        </div>
                ...
                // Check if it's a PDF or Google Drive document
                else if (/\.pdf(\?|$)/i.test(url) || (/drive\.google\.com/i.test(url) && /\/file\/d\//i
                        .test(url))) {
                    let embedUrl = url;
                    ...
                    bodyHtml = `
                        <div class="embed-container">
                            <iframe src="${embedUrl}" style="width:100%;height:500px;border:1px solid #ddd;border-radius:8px;" frameborder="0" allowfullscreen></iframe>
                        </div>
                        <div class="mt-3 text-center">
                            <a href="${url}" target="_blank" class="btn btn-primary">
                                <i class="fas fa-external-link-alt mr-1"></i> Buka di Tab Baru
                ...
                // For other websites that may block framing
                else if (/^(http|https):\/\//.test(url)) {
                    bodyHtml = `
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle mr-2"></i>
                            <strong>Link Website:</strong> Beberapa website tidak dapat ditampilkan dalam frame untuk alasan keamanan.
                        </div>
                ...
                // Fallback for other types
                    ...
                    bodyHtml = `
                        <div class="text-center">
                            ...
                            <p class="text-break">${url}</p>
                            <a href="${url}" target="_blank" class="btn btn-primary">
                                <i class="fas fa-download mr-1"></i> Download/Buka File
                            </a>
                        </div>`;
                }
