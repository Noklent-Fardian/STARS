<form action="{{ route('admin.dosenManagement.importExcel') }}" method="POST" id="form-import-dosen"
    enctype="multipart/form-data">
    @csrf
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header card-header py-3">
                <h5 class="modal-title m-0 font-weight-bold text-white">Import Data Dosen</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ route('admin.dosenManagement.generateTemplate') }}" class="btn btn-info btn-sm">
                ...
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0 pl-4 mt-1">
                        ...
                        <li><strong>Kolom B:</strong> NIDN/NIP</li>
                ...
                <div class="alert alert-warning">
                    <i class="fas fa-exclamation-triangle mr-2"></i> Password default untuk semua dosen yang diimport
...
<script>
    $(document).ready(function() {
        $("#form-import-dosen").on('submit', function(e) {
            e.preventDefault();
