...
@section('content')
            ...
            <div class="card welcome-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="mb-2">Selamat datang di dashboard Admin. Pantau dan kelola data prestasi mahasiswa
                            dengan mudah.</p>
                        <div class="d-flex gap-2">
                        </div>
                    </div>
                    <div class="ml-auto">
                        <a href="{{ route('admin.dashboard.exportPDF') }}" class="btn btn-danger btn-sm mr-2"
                            target="_blank">
                            <i class="fas fa-file-pdf"></i> Export Statistik PDF
                        </a>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800 counter"
                                data-target="{{ $stats['total_mahasiswa'] }}">0</div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800 counter"
                                data-target="{{ $stats['total_dosen'] }}">0</div>
                            <div class="mt-2 mb-0 text-muted text-xs">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800 counter"
                                data-target="{{ $stats['total_prestasi'] }}">0</div>
                            <div class="mt-2 mb-0 text-muted text-xs">
                                <span class="text-warning mr-2"><i class="fas fa-trophy"></i></span>
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card stat-card h-100 clickable"
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-uppercase mb-1">Pending Verifikasi Prestasi</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800 counter"
                                data-target="{{ $stats['pending_verifikasi_prestasi'] }}">0</div>
                            <div class="mt-2 mb-0 text-muted text-xs">
        ...
        <!-- Pending Verifikasi Lomba -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card stat-card h-100 clickable"
                onclick="window.location='{{ route('admin.lomba.verification') }}'">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-uppercase mb-1">Pending Verifikasi Lomba</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800 counter"
                                data-target="{{ $stats['pending_verifikasi_lomba'] }}">0</div>
                            <div class="mt-2 mb-0 text-muted text-xs">
                                <span class="text-info mr-2"><i class="fas fa-hourglass-half"></i></span>
                                <span>Menunggu verifikasi</span>
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <!-- Total Lomba -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card stat-card h-100 clickable" onclick="window.location='{{ route('admin.lomba.index') }}'">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-uppercase mb-1">Total Lomba</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800 counter"
                                data-target="{{ $stats['total_lomba'] }}">0</div>
                            <div class="mt-2 mb-0 text-muted text-xs">
                                <span class="text-primary mr-2"><i class="fas fa-medal"></i></span>
                                <span>Lomba tersedia</span>
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="stat-icon bg-primary text-white">
        ...
        <!-- Total Admin -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card stat-card h-100 clickable" onclick="window.location='{{ route('admin.admin.index') }}'">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-uppercase mb-1">Total Admin</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800 counter"
                                data-target="{{ $stats['total_admin'] }}">0</div>
                            <div class="mt-2 mb-0 text-muted text-xs">
                                <span class="text-secondary mr-2"><i class="fas fa-users-cog"></i></span>
                        ...
                        <div class="col-md-3 mb-2">
                            <a href="{{ route('admin.prestasi.verification') }}" class="btn btn-warning btn-block">
                                ...
                                @if ($stats['pending_verifikasi_prestasi'] > 0)
                                    <span
                                        class="badge badge-light ml-1">{{ $stats['pending_verifikasi_prestasi'] }}</span>
                                @endif
                            </a>
                        </div>
                        <div class="col-md-3 mb-2">
    ...
    <div class="row">
        ...
        <!-- Yearly Verification Chart -->
        <div class="col-xl-6 col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Verifikasi Prestasi Tahunan</h6>
                    <div class="dropdown">
                        <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                            <i class="fas fa-ellipsis-v"></i>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="#" onclick="exportChart('yearlyVerification')">Export
                                PNG</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="chart-area" style="height: 300px;">
                        <canvas id="yearlyVerificationChart"></canvas>
                    </div>
                    <div class="mt-3 text-center">
                        <small class="text-muted">
                            Menampilkan jumlah prestasi yang telah diverifikasi oleh dosen dan admin per tahun
                        </small>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <!-- Verified Prestasi by Tingkatan -->
        <div class="col-xl-6 col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Prestasi Terverifikasi by Tingkatan</h6>
                    <div class="dropdown">
                        <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                            <i class="fas fa-ellipsis-v"></i>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="#" onclick="exportChart('verifiedTingkatan')">Export
                                PNG</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="chart-pie pt-4 pb-2" style="height: 250px;">
                        <canvas id="verifiedTingkatanChart"></canvas>
                    </div>
                    <div class="mt-3 text-center">
                        <small class="text-muted">
                            Menampilkan prestasi yang telah diverifikasi lengkap oleh dosen dan admin
                        </small>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary">Top 10 Verifikasi Prestasi Terbaru</h6>
                    ...
                    @forelse($recentPrestasi as $prestasi)
                        <div class="media mb-3 activity-item">
                            ...
                            <div class="media-body">
                                ...
                                <div class="text-sm text-gray-600">Peringkat:
                                    {{ $prestasi->peringkat->peringkat_nama ?? 'N/A' }}</div>
                            </div>
                        </div>
                    @empty
                        <div class="text-center text-muted py-4">
                            <i class="fas fa-trophy fa-3x mb-3 text-gray-300"></i>
                            <p>Belum ada prestasi terverifikasi</p>
                        </div>
                    @endforelse
                </div>
            </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary">Top 10 Lomba Terverifikasi Terbaru</h6>
                ...
                <div class="card-body" style="max-height: 400px; overflow-y: auto;">
                    ...
                    @empty
                        <div class="text-center text-muted py-4">
                            ...
                            <p>Belum ada lomba terverifikasi</p>
                        </div>
                    @endforelse
                </div>
            </div>
    ...
    <script>
        ...
        const monthlyChart = new Chart(monthlyCtx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Lomba Terverifikasi',
                    data: @json($monthlyData['lomba']),
        ...
        // Yearly Verification Chart
        const yearlyVerificationCtx = document.getElementById('yearlyVerificationChart').getContext('2d');
        const yearlyVerificationChart = new Chart(yearlyVerificationCtx, {
            type: 'line',
            data: {
                labels: @json($yearlyVerificationData['years']),
                datasets: [{
                    label: 'Prestasi Terverifikasi',
                    data: @json($yearlyVerificationData['verified']),
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            label: function(context) {
                                return `${context.dataset.label}: ${context.parsed.y} prestasi`;
                            }
                        }
                    }
                },
        ...
        // Verified Prestasi by Tingkatan Chart
        const verifiedTingkatanCtx = document.getElementById('verifiedTingkatanChart').getContext('2d');
        const verifiedTingkatanChart = new Chart(verifiedTingkatanCtx, {
            type: 'doughnut',
            data: {
                labels: @json($verifiedPrestasiByTingkatan->pluck('tingkatan_nama')),
                datasets: [{
                    data: @json($verifiedPrestasiByTingkatan->pluck('verified_total')),
                    backgroundColor: [
                        '#4e73df',
                        '#1cc88a',
                        '#36b9cc',
