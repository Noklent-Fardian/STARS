...
@section('title', 'Data Program Studi | STARS')
...
@section('content')
    <div class="card shadow-sm rounded-lg overflow-hidden">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-white">Daftar Program Studi</h6>
        </div>
        <div class="card-body">
            @if (session('success'))
            ...
            <div class="table-responsive">
                <table class="table table-hover table-striped" id="table_prodi">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Kode Prodi</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            dataProdi = $('#table_prodi').DataTable({
                ...
                processing: true,
                ajax: {
                    url: "{{ route('admin.master.prodi.list') }}",
                    dataType: "json",
                    type: "GET"
                },
                columns: [
                    { data: "id", className: "text-center", width: "5%" },
                    { data: "prodi_kode", width: "30%" },
                    { data: "prodi_nama", width: "40%" },
            ...
            $('#searchBox').on('keyup', function () {
                dataProdi.search(this.value).draw();
            });
