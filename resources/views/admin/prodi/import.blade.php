<form action="{{ route('admin.master.prodi.importExcel') }}" method="POST" id="form-import"
    enctype="multipart/form-data">
    @csrf
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header card-header py-3">
                <h5 class="modal-title m-0 font-weight-bold text-white">Import Data Program Studi</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ route('admin.master.prodi.generateTemplate') }}" class="btn btn-info btn-sm">
                ...
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0 pl-4 mt-1">
                        <li><strong>Kolom A:</strong> Nama Prodi</li>
                        <li><strong>Kolom B:</strong> Kode Prodi</li>
                    </ul>
                </div>
                <div class="form-group">
