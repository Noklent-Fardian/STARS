<form action="{{ route('admin.master.bidangKeahlian.importExcel') }}" method="POST" id="form-import"
    enctype="multipart/form-data">
    @csrf
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header card-header py-3">
                <h5 class="modal-title m-0 font-weight-bold text-white">Import Data Bidang Keahlian</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ route('admin.master.bidangKeahlian.generateTemplate') }}" class="btn btn-info btn-sm">
                ...
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0 pl-4 mt-1">
                        <li><strong>Kolom A:</strong> Nama Bidang Keahlian</li>
                    </ul>
                </div>
                <div class="form-group">
                    <label>Pilih File</label>
                    <input type="file" name="file_bidang" id="file_bidang" class="form-control" required>
                    <small id="error-file_bidang" class="error-text form-text text-danger"></small>
                </div>
            </div>
