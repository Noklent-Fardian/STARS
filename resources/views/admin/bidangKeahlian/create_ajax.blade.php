<form action="{{ route('admin.master.bidangKeahlian.storeAjax') }}" method="POST" id="form-tambah">
    @csrf
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white font-weight-bold">
                    <i class="fas fa-plus-circle mr-2"></i> Tambah Bidang Keahlian
                </h5>
...
<script>
    $(document).ready(function () {
        // Efek transisi form-group saat modal tampil
