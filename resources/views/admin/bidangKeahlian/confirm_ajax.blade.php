    ...
    <form action="{{ route('admin.master.bidangKeahlian.destroyAjax', $keahlian->id) }}" method="POST" id="form-delete">
        ...
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title text-white font-weight-bold">
                        <i class="fas fa-trash-alt mr-2"></i> Hapus Bidang Keahlian
                    </h5>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                <div class="modal-body p-4">
                    <div class="alert alert-warning">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Apakah Anda yakin ingin menghapus bidang keahlian berikut?</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 alert alert-danger">
                        <i class="fas fa-exclamation-circle mr-2"></i> Menghapus bidang keahlian ini mungkin akan
                        mempengaruhi data yang terkait.
                    </div>
                </div>
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    if (response.status) {
                                        ...
                                        const isShowPage = $('.card-header:contains("Detail Bidang Keahlian")').length > 0;
                                        ...
                                        if (isShowPage) {
                                            ...
                                            Swal.fire({
                                                ...
                                                willClose: () => {
                                                    ...
                                                    window.location.href = "{{ route('admin.master.bidangKeahlian.index') }}";
                                                }
                                            });
                                        } else {
