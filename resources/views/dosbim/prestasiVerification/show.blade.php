...
@section('page-title', 'Verifikasi Prestasi Dosen')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dosen.prestasiVerification.index') }}">Verifikasi Prestasi</a></li>
...
@section('content')
    <div class="container-fluid">
        ...
        @if ($verifikasi->verifikasi_dosen_status === 'Menunggu')
            <div class="row mb-4">
                <div class="col-12">
                    <div class="verification-action-card">
                        <div class="card-header-custom">
                            ...
                            <h5 class="header-title">Keputusan Verifikasi Dosen</h5>
                        </div>
                        <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col-12">
                <a href="{{ route('dosen.prestasiVerification.index') }}" class="back-btn">
        ...
        function submitVerification(status) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('dosen.prestasiVerification.verify', $verifikasi->id) }}",
                        type: 'POST',
                        data: {
                            status: status,
                            ...
                            if (response.success) {
                                Swal.fire({
                                    ...
                                    window.location.href =
                                        "{{ route('dosen.prestasiVerification.index') }}";
                                });
                            } else {
