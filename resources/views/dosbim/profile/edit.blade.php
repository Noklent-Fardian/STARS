                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="dosen_nomor_telepon" class="form-control" value="{{ old('dosen_nomor_telepon', $dosen->dosen_nomor_telepon) }}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="keahlian_id" class="form-select" required>
                                ...
                                @foreach($keahlians as $keahlian)
                                    <option value="{{ $keahlian->id }}" {{ old('keahlian_id', $dosen->keahlian_id) == $keahlian->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="keahlian-tambahan-list">
                                @php
                                    $oldTambahan = old('keahlian_tambahan', $dosen->keahlianTambahan->pluck('id')->toArray());
                                @endphp
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="dosen_provinsi" class="form-control" value="{{ old('dosen_provinsi', $dosen->dosen_provinsi) }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Kota</label>
                            <input type="text" name="dosen_kota" class="form-control" value="{{ old('dosen_kota', $dosen->dosen_kota) }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Kecamatan</label>
                            <input type="text" name="dosen_kecamatan" class="form-control" value="{{ old('dosen_kecamatan', $dosen->dosen_kecamatan) }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Desa</label>
                            <input type="text" name="dosen_desa" class="form-control" value="{{ old('dosen_desa', $dosen->dosen_desa) }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-1">
                                <span class="badge keahlian-badge">{{ $dosen->keahlianUtama->keahlian_nama ?? '-' }}</span>
                            </div>
