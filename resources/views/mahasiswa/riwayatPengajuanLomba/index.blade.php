    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            dataRiwayat = $('#table_riwayat').DataTable({
                ...
                processing: true,
                ajax: {
                    url: "{{ route('mahasiswa.riwayatPengajuanLomba.list') }}",
                    dataType: "json",
                    type: "GET",
                    data: function (d) {
                ...
                columns: [
                    ...
                    { data: "lomba_nama", width: "25%", orderable: true },
                    { data: "lomba_penyelenggara", width: "18%", orderable: true },
                    { data: "lomba_kategori", width: "15%", orderable: true },
                    { data: "pendaftaran_status", width: "12%", orderable: true },
