...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('mahasiswa.riwayatPengajuanLomba.index') }}">Riwayat Pengajuan Lomba</a></li>
...
@section('content')
    <div class="container-fluid">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-8">
                                <div class="competition-content p-4 p-lg-5">
                                    ...
                                    <!-- Action Button for approved competitions -->
                                    @if ($submission->pendaftaran_status === 'Diterima')
                                        <div class="action-buttons">
                                            <button type="button" class="modern-btn secondary"
                                                onclick="selectApprovedCompetition({{ $submission->lomba_id }})">
        ...
        <div class="row mt-4">
            <div class="col-12">
                <a href="{{ route('mahasiswa.riwayatPengajuanLomba.index') }}" class="modern-btn outline">
...
@push('js')
    <script>
        function selectApprovedCompetition(lombaId) {
            Swal.fire({
                title: 'Konfirmasi',
                text: 'Apakah Anda yakin ingin mengajukan verifikasi prestasi untuk lomba ini?',
                icon: 'question',
