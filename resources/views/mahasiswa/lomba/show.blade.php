                    ...
                    <div class="card-body p-4">
                        <div class="timeline-modern">
                            <div class="timeline-item-modern">
                                ...
                                <div class="timeline-content-modern">
                                    ...
                                    <p class="timeline-date">{{ \Carbon\Carbon::parse($lomba->lomba_tanggal_mulai)->locale('id')->translatedFormat('l, d F Y') }}</p>
                            ...
                            <div class="timeline-item-modern">
                                ...
                                <div class="timeline-content-modern">
                                    ...
                                    <p class="timeline-date">{{ \Carbon\Carbon::parse($lomba->lomba_tanggal_selesai)->locale('id')->translatedFormat('l, d F Y') }}</p>
                        ...
                        <div class="duration-card">
                            ...
                            <div class="duration-content">
                                ...
                                <p class="duration-value">{{ $lomba->lomba_tanggal_mulai->diffInDays($lomba->lomba_tanggal_selesai) + 1 }} hari</p>
                            </div>
                        </div>
                    </div>
                </div>
