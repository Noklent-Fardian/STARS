            ...
            <div class="card welcome-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <h4 class="mb-1">Selamat Datang, {{ $mahasiswa->mahasiswa_nama ?? Auth::user()->username }}</h4>
                        <p class="mb-2">Anda dapat melihat dan memantau riwayat prestasi Anda melalui dashboard ini.</p>
                    </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card stat-card h-100 clickable"
                onclick="window.location='{{ route('mahasiswa.riwayatPengajuanPrestasi.index') }}'">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-uppercase mb-1">Total Prestasi</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                {{ number_format($stats['total_prestasi']) }}</div>
                            <div class="mt-2 mb-0 text-muted text-xs">
                                <span class="text-success mr-2">
                                    <i class="fas fa-check-circle"></i> {{ $stats['verified_prestasi'] }} Terverifikasi
                                </span>
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="mt-2 mb-0 text-muted text-xs">
                                @if ($stats['total_prestasi'] > 0)
                                    <span class="text-info">
                                        {{ number_format(($stats['verified_prestasi'] / $stats['total_prestasi']) * 100, 1) }}%
                                        dari total
                                    </span>
                                @else
        ...
        <!-- Total Pengajuan Lomba -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card stat-card h-100 clickable"
                onclick="window.location='{{ route('mahasiswa.riwayatPengajuanLomba.index') }}'">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-uppercase mb-1">Pengajuan Lomba</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                {{ number_format($stats['total_lomba_submissions']) }}</div>
                            <div class="mt-2 mb-0 text-muted text-xs">
                                <span class="text-success mr-2">
                                    <i class="fas fa-check"></i> {{ $stats['approved_lomba_submissions'] }} Disetujui
                                </span>
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-6 col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Peringkat Keseluruhan</h6>
                ...
                <div class="card-body">
                    <div class="text-center">
                        <div class="rank-circle mb-3">
                            ...
                            <div class="rank-total">dari {{ number_format($stats['total_mahasiswa']) }}</div>
                        </div>
                        <h5 class="font-weight-bold text-gray-800">Peringkat Anda</h5>
                        <p class="text-muted">di antara semua mahasiswa aktif</p>
                        @php
                            $percentile =
                                (($stats['total_mahasiswa'] - $stats['overall_rank'] + 1) / $stats['total_mahasiswa']) *
                                100;
                        @endphp
                        ...
                        <small class="text-muted">Top {{ number_format($percentile, 1) }}% mahasiswa</small>
                    </div>
                </div>
            </div>
        </div>

        <!-- Angkatan Ranking Card -->
        <div class="col-xl-6 col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Peringkat Angkatan {{ $mahasiswa->mahasiswa_angkatan }}
                    </h6>
                    <i class="fas fa-users text-gray-300"></i>
                </div>
                <div class="card-body">
                    <div class="text-center">
                        <div class="rank-circle mb-3 angkatan">
                            <div class="rank-number">#{{ $stats['angkatan_rank'] }}</div>
                            <div class="rank-total">dari {{ number_format($stats['total_mahasiswa_angkatan']) }}</div>
                        </div>
                        <h5 class="font-weight-bold text-gray-800">Peringkat Angkatan</h5>
                        <p class="text-muted">di antara mahasiswa angkatan {{ $mahasiswa->mahasiswa_angkatan }}</p>
                        @php
                            $angkatanPercentile =
                                (($stats['total_mahasiswa_angkatan'] - $stats['angkatan_rank'] + 1) /
                                    $stats['total_mahasiswa_angkatan']) *
                                100;
                        @endphp
                        <div class="progress mb-2">
                            <div class="progress-bar bg-gradient-success" role="progressbar"
                                style="width: {{ $angkatanPercentile }}%" aria-valuenow="{{ $angkatanPercentile }}"
                                aria-valuemin="0" aria-valuemax="100">
                            </div>
                        </div>
                        <small class="text-muted">Top {{ number_format($angkatanPercentile, 1) }}% angkatan</small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Perkembangan Skor Tahunan</h6>
                    <div class="dropdown">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center">
                        <small class="text-muted">
                            Menampilkan total skor yang diperoleh dari prestasi yang terverifikasi per tahun
                        </small>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('mahasiswa.riwayatPengajuanPrestasi.index') }}"
                ...
                <div class="card-body" style="max-height: 400px; overflow-y: auto;">
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <p class="mb-1 text-sm text-muted">
                                        ...
                                        {{ $prestasi->penghargaan->peringkat->peringkat_nama ?? 'N/A' }}
                                    </p>
                                    <small class="text-muted">
                    ...
                    @empty
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">Belum ada prestasi yang diajukan</p>
                            <a href="{{ route('student.achievement.create') }}" class="btn btn-primary btn-sm">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('mahasiswa.riwayatPengajuanLomba.index') }}" class="btn btn-sm btn-primary">Lihat
                        Semua</a>
                </div>
                <div class="card-body" style="max-height: 400px; overflow-y: auto;">
